...
OS_STK  *OSTaskStkInit (void (*task)(void *pd), void *pdata, OS_STK *ptos, INT16U opt)
{
	...
	*--stk = (INT32U)task;					/* LR(NULL) */
	*--stk = (INT32U)0xCCCCCCCC;			/* R12 */
	*--stk = (INT32U)0xBBBBBBBB;			/* R11 */
	*--stk = (INT32U)0xAAAAAAAA;			/* R10 */
	*--stk = (INT32U)0x99999999;			/* R9 */
	*--stk = (INT32U)0x88888888;			/* R8 */
	*--stk = (INT32U)0x77777777;			/* R7 */
	*--stk = (INT32U)0x66666666;			/* R6 */
	*--stk = (INT32U)0x55555555;			/* R5 */
	*--stk = (INT32U)0x44444444;			/* R4 */
	*--stk = (INT32U)0x33333333;			/* R3 */
	*--stk = (INT32U)0x22222222;			/* R2 */
	*--stk = (INT32U)0x11111111;			/* R1 */
	*--stk = (INT32U)pdata;					/* R0 */
	*--stk = (INT32U)task;					/* PC */
	*--stk   = (INT32U)0x10;				/* CPSR(User mode with IRQ&FIQ enabled,N/Z/C/V = 0/0/0/0) */
	OS_EXIT_CRITICAL();
